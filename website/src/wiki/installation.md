...
```yml
plugins:
  - https://github.com/yesoreyeram/grafana-infinity-datasource/releases/download/v0.8.0-dev.4/yesoreyeram-infinity-datasource-0.8.0-dev.5.zip;yesoreyeram-infinity-datasource
```
...
```shell
docker run -p 3000:3000 -e "GF_INSTALL_PLUGINS=https://github.com/yesoreyeram/grafana-infinity-datasource/releases/download/v0.8.0-dev.4/yesoreyeram-infinity-datasource-0.8.0-dev.5.zip;yesoreyeram-infinity-datasource" grafana/grafana:8.2.2
```
