...
The Infinity data source can connect to virtually any API that returns JSON, CSV, XML, or GraphQL data. This section provides step-by-step guides for integrating with popular platforms.
...
Find more integration examples and community contributions in the [GitHub Discussions](https://github.com/grafana/grafana-infinity-datasource/discussions) page.
