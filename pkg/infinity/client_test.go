...
func Test_GetTLSConfigFromConfig(t *testing.T) {
	t.Run("default settings should return default client", func(t *testing.T) {
		got, err := infinity.GetTLSConfigFromConfig(infinity.InfinityConfig{})
	...
	t.Run("invalid TLSAuthWithCACert should throw error", func(t *testing.T) {
		_, err := infinity.GetTLSConfigFromConfig(infinity.InfinityConfig{
