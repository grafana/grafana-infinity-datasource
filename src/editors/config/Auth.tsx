...
import { Icon, InlineFormLabel, LegacyForms, RadioButtonGroup, Combobox, Grid, Link, useTheme2, type ComboboxOption } from '@grafana/ui';
            ...
            {authType === 'aws' && (
              <>
                <div className="gf-form">
                  ...
                  <Combobox width={24} options={AWSRegions as Array<ComboboxOption<string>>} placeholder="us-east-2" onChange={(e) => onAwsRegionChange(e.value!)} value={props.options.jsonData?.aws?.region || ''} />
                </div>
                <div className="gf-form">
                  <FormField
                    label="Service"
