                    ...
                    <div className="gf-form-inline">
                        <div className="gf-form">
                            ...
                            <Select
                                ...
                                value={SCRAP_QUERY_RESULT_COLUMN_FORMATS.find((field: any) => field.value === column.type) || defaultScrapResultFormat}
                            ...
                            ></Select>
                            <span className="btn btn-success btn-small" style={{ margin: '5px' }} onClick={() => { onColumnAdd(); }}>
                                +
							</span>
                            <span className="btn btn-danger btn-small" style={{ margin: '5px' }} onClick={() => { onColumnRemove(index); }}>
                                x
							</span>
                        </div>
                    </div>
