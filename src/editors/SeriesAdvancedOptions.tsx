                                ...
                                <div className="gf-form">
                                    <label className="gf-form-label width-6">Data Overrides</label>
                                    {
                                        query.dataOverrides && query.dataOverrides.length > 0 ? <></> : <>
                                            <label className="gf-form-label query-keyword width-20" onClick={() => addDataOverride()}>Click to add Overrides</label>
                                        </>
                                    }
                                </div>
                            </ div>
                                        ...
                                        query.dataOverrides.map((override: DataOverride, index: number) => {
                                            return <div className="gf-form-inline" >
                                                <div className="gf-form">
                                                    ...
                                                    <input type="text" className="gf-form-input min-width-10 width-10" value={override.values[0]} onChange={(e) => onTextChange(e.target.value, `dataOverrides[${index}].values[0]`)} placeholder="Value 1"></input>
                                                    <Select
                                                        className="width-4"
                                                    ...
                                                    ></Select>
                                                    <input type="text" className="gf-form-input min-width-10 width-10" value={override.values[1]} onChange={(e) => onTextChange(e.target.value, `dataOverrides[${index}].values[1]`)} placeholder="Value 2"></input>
                                                    <input type="text" className="gf-form-input min-width-8 width-8" value={override.override} onChange={(e) => onTextChange(e.target.value, `dataOverrides[${index}].override`)} placeholder="Override value"></input>
                                                    <span className="btn btn-success btn-small" style={{ margin: '5px' }} onClick={() => addDataOverride()}>+</span>
                                                    <span className="btn btn-danger btn-small" style={{ margin: '5px' }} onClick={() => removeDataOverride(index)}>X</span>
                                                </div>
                                            </div>
                                        })
                                    }
